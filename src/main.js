...
document.querySelector('#app').innerHTML = `
  <main class="shell">
    <nav class="topbar"><div class="brand"><span class="brand-mark" aria-hidden="true">✦</span><span>Alufivia</span></div><div class="nav-actions"><div class="travel-switch" aria-label="Tipo de búsqueda"><button class="travel-switch-btn is-active" type="button" data-travel-view="hotels">⌂ Alojamientos</button><button class="travel-switch-btn" type="button" data-travel-view="flights">✈ Vuelos y destinos</button><button class="travel-switch-btn" type="button" data-travel-view="combined">✈+ Hotel + vuelo</button></div><button class="ghost saved-nav" id="savedBtn">♡ Favoritos <span id="savedCount">0</span></button><button class="ghost" id="adminBtn" hidden>Administración</button><button class="ghost" id="accountBtn">◉ Acceder</button></div></nav>
    <section id="hotelView" class="travel-view">
      <section class="hero"><div><div class="eyebrow">Alufivia · viajes con rumbo</div><h1>El viaje que imaginas.<br>Al precio que buscas.</h1><p>Compara alojamientos, vuelos y fechas para encontrar una opción que encaje contigo.</p></div><div class="hero-art" aria-hidden="true"><div class="route-orbit"><span class="route-start">⌂</span><span class="route-plane">✈</span><span class="route-end">✦</span></div></div></section>
